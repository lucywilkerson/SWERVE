# Execute using
#   python -m swerve.site_stats_test
...
def _write_timeseries(test_name, start_time, stop_time, value_range, data_type, mode='sin', nan_interval=None, seed=None, plot=False):
    import os
    import random
...
def _test_site(site, metrics, stats, data_types=None):
    """
    ...
    for test in test_dict.keys():
        for data_type in test_dict[test].keys():
            ...
            if run_tests:
                ...
                _test_site(site=test, metrics=test_metrics, stats=test_stats, data_types=data_type)
