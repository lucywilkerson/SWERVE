...
def process_data(data_dir, info_dir, buffer_distance=1000):
    """
    ...
    device_loc = os.path.join(info_dir, "info", "info.csv")
...
if __name__ == "__main__":
    ...
    for site in device_to_line_voltages.keys():
        ...
        if site == 10052:
            print(f"Site {site} has the following voltages: {device_to_line_voltages[site]}")
